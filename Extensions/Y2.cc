...
//
// ********************************************************************
// *  TOPAS Y2 Custom component of DCS                                *
// *                                                                  *
...
Y2::Y2(TsParameterManager* pM, TsExtensionManager* eM, TsMaterialManager* mM, TsGeometryManager* gM,
...
G4VPhysicalVolume* Y2::Construct()
{
	BeginConstruction();
	...
	{
	G4ThreeVector* pos = new G4ThreeVector(0.0,DefaultPositive,YAD);
	G4RotationMatrix* rot = new G4RotationMatrix();
